...
Image(filename='./figures/07_07.png',width=700)
...
Image(filename='./figures/07_09.png',width=500)
...
Image(filename='./figures/07_16.png', width=500) 
...
get_ipython().system('jupyter nbconvert --to script  chapter_7.ipynb --output ch07')
