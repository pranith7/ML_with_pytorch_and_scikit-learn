...
Image(filename='./figures/10_07.png', width=400) 
...
Image(filename='figures/10_13.png', width=500) 
...
get_ipython().system('jupyter nbconvert --to script  chapter_10.ipynb --output ch10')
